				...
				<div className="grid gap-4 xl:gap-7 grid-cols-12">
					<div className="col-span-12 xl:col-span-7">
						<div className="profile-content-area text-md leading-relaxed">
							<p className="mb-8">Mijn vrienden en collega's zouden mij omschrijven als een analytische, nauwkeurige en pragmatische probleemoplosser met een enorme drive om te blijven leren en mijn kennis te verbreden. In mijn vrije tijd leer ik graag meer over onderwerpen die ik interessant vind. Zo verdiep ik mij in het ontwikkelen van webapplicaties met React, VUE en Tailwind, met als kers op de taart gave GSAP animaties. Of maak ik een digitale versie van (bord)spellen in Vanilla Javascript. Daarnaast houd ik van gamen, speel ik (bas)gitaar en bezoek ik graag een rock / metal concert.</p>
							<p className="mb-8">Ik word gelukkig van het werken aan uitdagende projecten in een leuk en informeel team. Met het maken van custom oplossingen, het verdiepen in diverse webtechnieken, en het contact hebben met klanten en collega's houd ik mezelf up-to-date als webdeveloper en werknemer.</p>
